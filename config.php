...
if($lang == 'th')
{
    ...
    $Contact = "ติดต่อ";
    $faddress = "ลาดกระบัง กรุงเทพ 10520";
    ...
    $e80= " Ems / 80 ต่อชิ้น";
    $historys="เว็บไซต์ที่ขายโทรศัพท์ที่ถูก ดี เเละน่าเชื่อถือที่สุดในประเทศไทย ก่อตั้งเมื่อปี 2021";
    $map="แผนที่";
...
else if($lang == 'en')
{
    ...
    $Contact = "Contact";
    $faddress = "Ladkrabang. Bangkok 10520";
    $femail = "info@example.com";
    $ftel = "+ 01 234 567 88";
    $lusername = "Username";
    $lpassword = "Password"; 
    ...
    $historys="The website that sells the cheapest, good and most reliable phones in Thailand. Established in 2021.";
    $map="Map";
    $profile="Profile";
    $user="Username";
    $name="Name";
