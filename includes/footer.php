...
<!-- Footer -->
<footer class="page-footer font-small teal pt-4 bg-light text-black">
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3 bg-light text-dark font-weight-bold">© 2021 Copyright:
      <a  class="text-dark"> SPShop Ladkrabang</a>
    </div>
    <!-- Copyright -->
